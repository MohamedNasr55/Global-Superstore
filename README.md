...
1. The first one is Sales Analysis, on this page we have the total number of customers, total orders, net profit, and number of quantities  
...
2. The second analysis of orders we can see the number of orders, total orders, total orders, total orders, total orders with discount, and total monthly sales 
...
3-Third analysis of customer behavior Number of sales by subcategory
